...
## 概要
List.js ( https://listjs.com/ )とTSVによる書誌1万件規模での書誌検索サイトのサンプルページである。
...
## HTMLテンプレート
- List.js の付属のテンプレート機能( https://listjs.com/docs/ )を使っている
    - HTML要素のclass属性を使い値をセットする
    - HTML要素の属性に値をセットするには、valueNamesで属性名を指定する
    - HTML要素を入力にすることもできる
...
- HTML要素の値や属性の設定法はできるが、複雑な処理には難がある。
### List.jsのレコード区切り判定
